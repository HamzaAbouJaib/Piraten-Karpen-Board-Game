...
|      | F15 | Introduce fortune cards into the game                                                                                                                                                                                                     | P      |          |           |
|      | F16 | Shuffle cards at the start of a game and in the case all cards are used, reshuffle the cards and start picking again                                                                                                                      | P      |          |           |
|      | F17 | Score points: sea battle fortune card allows player to gain or lose a specified number of points                                                                                                                                          | P      |          |           |
|      | F18 | Strategy: when a sea battle card is picked prioritize rolling sabers                                                                                                                                                                      | P      |          |           |
| ...  | ... | ...                                                                                                                                                                                                                                       |
